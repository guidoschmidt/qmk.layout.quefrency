...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    MO(_FN1), KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,           KC_ENT,  KC_BSPC, KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FN1] = LAYOUT(
    ...
    _______,KC_GRAVE, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
